  ...
  return (
    ...
    <section className=" bg-background">
      <div className="container mx-auto flex flex-col xl:flex-row items-center gap-8 px-4">
        ...
        <div className="xl:text-left md:text-center"><Heading title="UI/UX design"/></div>
          <Content title="We specialize in creating user-friendly and visually appealing designs for websites and mobile apps.
        Our UI/UX design services are tailored to create intuitive and engaging user experiences."/>
