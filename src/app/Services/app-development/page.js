  ...
  return (
    ...
    <section className=" bg-background">
      <div className="container mx-auto flex flex-col xl:flex-row items-center gap-8 px-4">
        ...
        <div className="w-80% xl:w-1/2 text-justify md:text-left">
        <div className="xl:text-left md:text-center"><Heading title="Mobile app development"/></div>
          <Content title="Our mobile app development services bring your app ideas to life for iOS and Android using React Native, Swift, and Kotlin."/>
          <Content title="Empower your online presence. We design engaging, responsive websites for lasting impact."/>

          {/* Technologies Section */}
          <div className="xl:text-left md:text-center md:px-8 xl:px-0">
